...
<h1 className='text-center text-white  text-2xl ' > robotics club for enthusiastic students</h1>
</div>
{/* 2 */}
...
{/* 3 */}
  <div>
    <h1 className='text-center text-white  text-lg  md:text-2xl'>Email us at : </h1>  
    <p className='text-center text-white   text-lg md:text-xl '>a_kadache@estin.dz</p>
  </div>
  {/* 4 */}
        <div>
            <p className='text-center  text-white  text-2xl mb-4'> Follow us </p>
        ...
        <div className='h-[1px]  mt-4 w-[80%] mx-auto bg-white'></div>
              <p className='text-center  mt-4    text-white  text-2xl flex-grow-0'>2024 Siruis. All rights reserved.</p>
